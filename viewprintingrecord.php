...
<html>
<head>
    <title>The Specific Book Printing Record Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT PrintingID, BookID, StaffID, PrinterName, PrinterType, PrintingDate, PrintingFee, PrintingStatus, QRCode, SubmitDate, PrintPriority, BookingStatus, PaymentStatus, PrinterMail FROM printings WHERE PrintingID = ? LIMIT 0,1";
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($printpriority, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
