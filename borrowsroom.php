...
<head>
    ...
    <title>The Room Borrowing Page For Student</title>
    <style>
    * {
...
<div class="sidebar">
  ...
  <a class="active" href="borrowsroom.php">Rent Study Room</a>
...
<div class="content">
  ...
  <h2>The room borrowing page for student</h2>
  <h3>The room borrowing form for student</h3>

  <div class="container">
    <form action="borrowsroom.php" method="POST">
    <div class="row">
        <div class="col-25">
