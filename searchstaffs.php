...
<html>
<head>
    <title>The Staffs Searching Page For Administrator</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Searched Staffs</h1>
        </div>

        <form action="searchstaffs.php" method="POST" autocomplete="off">
            <label for="txt-searchedstaffname">Searched Staff Name</label>
            <input type="text" placeholder="Enter searched staff name here" id="txt-searchedstaffname" name="txt-searchedstaffname" pattern=".{1,30}" title="Book name must contain at least 1 and maximum 30 characters" data-clear-btn="true" data-mini="true">
        ...
        // select all data
        $query = "SELECT StaffID, AdminID, StaffName, StaffUsername, StaffPhone, StaffMail, StaffStatus FROM staffs WHERE StaffName LIKE'%".$_SESSION['searched_staffname']."%' ORDER BY StaffID ASC";
