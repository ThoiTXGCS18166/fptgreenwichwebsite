...
<html>
<head>
    <title>The Laptops Viewing Page For Administrator</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Current Laptops</h1>
        </div>

        <form action="viewlaptops.php" method="POST" autocomplete="off">
        ...
        // select all data
        $query = "SELECT LaptopID, AdminID, LaptopName, OperatingSystem, LaptopStatus, Size FROM laptops ORDER BY LaptopID ASC";
