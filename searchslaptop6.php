...
<head>
    ...
    <title>The Laptop Searching Page For Students</title>
    <style>
    * {
...
<div class="content">
  ...
  <form action="searchslaptop6.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <form action="searchslaptop6.php" method="POST">
