...
<html>
<head>
    <title>The Room Borrowing Record Canceling Page For Student</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Cancel Room Borrowing Record</h1>
        </div>
        ...
        try {
            ...
            $query = "SELECT RoomRecordID, RoomID, BorrowerName, BorrowerType, StartDate, EndDate, RecordFee, BorrowingStatus, ReturnStatus, SubmitDate, BorrowPriority, BookingStatus, BorrowerMail FROM roomrecords WHERE RoomRecordID = ? LIMIT 0,1";
        ...
        if($_POST){
            ...
            try{
                ...
                if($borrowingstatus == 1 && $bookingstatus == 0) {
                    echo '<script>alert("This room borrowing record can not be disabled")</script>';
                } else {
                    // write update query
                    // in this case, it seemed like we have so many fields to pass and 
                    // it is better to label them and not use question marks
                    $query = "UPDATE roomrecords 
                    SET RoomID=:roomid, BorrowerName=:borrowername, BorrowerType=:borrowertype, StartDate=:startdate, EndDate=:enddate, RecordFee=:recordfee, BorrowingStatus=:borrowingstatus, ReturnStatus=:returnstatus, SubmitDate=:submitdate, BorrowPriority=:borrowpriority, BookingStatus=:bookingstatus, BorrowerMail=:borrowermail
            ...
            <table class='table table-hover table-responsive table-bordered'>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href='viewsroomborrowingrecords.php' class='btn btn-danger'>Back to view room borrowing records</a>
                    </td>
                </tr>
            </table>
        </form>
