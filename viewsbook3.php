...
<div class="content">
  ...
  <form action="viewsbook3.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewsbook17detail.php">View Book Details</a></p>
    <form action="viewsbook3.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewsbook18detail.php">View Book Details</a></p>
    <form action="viewsbook3.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook19detail.php">View Book Details</a></p>
    <form action="viewsbook3.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook20detail.php">View Book Details</a></p>
    <form action="viewsbook3.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewsbook3.php" class="active">3</a>
    </div>
  </div>
