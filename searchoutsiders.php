...
<html>
<head>
    <title>The Outsiders Searching Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Searched Outsiders</h1>
        </div>

        <form action="searchoutsiders.php" method="POST" autocomplete="off">
        ...
        // select all data
        $query = "SELECT OutsiderID, StaffID, OutsiderName, OutsiderUsername, OutsiderPhone, OutsiderMail, OutsiderStatus, PaymentStatus FROM outsiders WHERE OutsiderName LIKE'%".$_SESSION['searched_outsidername']."%' ORDER BY OutsiderID ASC";
