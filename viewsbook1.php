...
<div class="content">
  ...
  <form action="viewsbook1.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewsbook1detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewsbook2detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook3detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook4detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewsbook5detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook6detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook7detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewsbook8detail.php">View Book Details</a></p>
    <form action="viewsbook1.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewsbook1.php" class="active">1</a>
    <a href="viewsbook2.php">2</a>
