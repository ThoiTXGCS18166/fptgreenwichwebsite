...
<head>
    ...
    <title>The Homepage For Teacher</title>
    <style>
    * {
...
<div class="sidebar">
  <a class="active" href="home4.php">Home</a>
...
<div class="content">
  ...
  <h2>The homepage for teacher</h2>
  ...
  <div class="container">
    <div class="row">
      <div class="column-66">
        ...
        <button class="button" onclick="updateTeacher()">Update Info</button>
      </div>
      <div class="column-33">
  ...
  <div class="container">
    <div class="row">
      <div class="column-66">
        ...
        <button class="button" onclick="aboutTeacher()">About Us</button>
      </div>
      <div class="column-33">
...
<script>
  function viewBooks() {
    location.replace('viewtbook1.php');
  }

  function viewLaptops() {
    location.replace('viewtlaptop.php');
  }

  function borrowBooks() {
    location.replace('borrowtbook.php');
  }

  function borrowLaptops() {
    location.replace('borrowtlaptop.php');
  }

  function borrowRooms() {
    location.replace('borrowtroom.php');
  }

  function printDocuments() {
    location.replace('printtdocument.php');
  }

  function viewbookborrowingRecords() {
    location.replace('viewtbookborrowingrecords.php');
  }

  function viewlaptopborrowingRecords() {
    location.replace('viewtlaptopborrowingrecords.php');
  }

  function viewroomborrowingRecords() {
    location.replace('viewtroomborrowingrecords.php');
  }

  function viewbookprintingRecords() {
    location.replace('viewtbookprintingrecords.php');
  }

  function updateTeacher() {
    location.replace('updateteacherinfo.php');
  }
