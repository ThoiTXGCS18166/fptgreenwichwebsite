<?php
  ...
  if(isset($_POST['btn-print'])){   
    $staffid=1;
    $printername=$_POST['txt-outsiderusername'];
    $bookname=$_POST['txt-bookname'];
    $printertype="Outsider";
    $printingdate=$_POST['txt-printingdate'];
    $printingfee="25 USD";
    $printingstatus=0;
    $qrcode="oprintqrcode3.jpg";
    date_default_timezone_set("Asia/Ho_Chi_Minh");
    ...
    $sql="SELECT * FROM outsiders WHERE OutsiderUsername='".$printername."'";
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($paymentstatus == 0) {
        echo '<script>alert("Request for printing book submitted unsuccessfully. The current outsider has yet made payment for the yearly membership fee at the library")</script>';
      } else {
        ...
        if(mysqli_num_rows($result) > 0) {
          ...
          if($bookstatus==0) {
            ...
            VALUES ('$bookid', '$staffid', '$printername', '$printertype', '$printingdate', '$printingfee', '$printingstatus', '$qrcode', '$submitdate', '$printpriority','$bookingstatus', '$paymentstatus1', '$printermail')";   
  ...
  if(isset($_POST['btn-pay'])){
    $_SESSION['printer_name'] = $_POST['txt-outsiderusername'];
      ...
      if($paymentstatus == 0) {
        ...
        if(mysqli_num_rows($result) > 0) {
          ...
          if($bookstatus==0) {
            ...
            header("location: oprintpayment.php");
          }
        } else {
...
<head>
    ...
    <title>The Document Printing Page For Outsider</title>
    <style>
    * {
...
<div class="sidebar">
  ...
  <a class="active" href="printodocument.php">Print Documents</a>
...
<div class="content">
  ...
  <h2>The document printing page for outsider</h2>
  <h3>The document printing form for outsider</h3>

  <div class="container">
    <form action="printodocument.php" method="POST">
    <div class="row">
        <div class="col-25">
    ...
    <div class="row">
        ...
        <div class="col-75">
        <input type="text" id="txt-recordfee" name="txt-recordfee" value="Print fee is 25 USD (approximately 575000 VND) for outsider" readonly data-mini="true">
        </div>
    </div>
    <div class="row">
