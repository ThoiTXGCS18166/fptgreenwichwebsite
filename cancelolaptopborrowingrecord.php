...
<html>
<head>
    <title>The Laptop Borrowing Record Canceling Page For Outsider</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Cancel Laptop Borrowing Record</h1>
        </div>
        ...
        try {
            ...
            $query = "SELECT LaptopRecordID, LaptopID, BorrowerName, BorrowerType, StartDate, EndDate, RecordFee, BorrowingStatus, ReturnStatus, SubmitDate, BorrowPriority, BookingStatus, BorrowerMail FROM laptoprecords WHERE LaptopRecordID = ? LIMIT 0,1";
        ...
        if($_POST){
            ...
            try{
                ...
                if($borrowingstatus == 1 && $bookingstatus == 0) {
                    echo '<script>alert("This laptop borrowing record can not be disabled")</script>';
                } else {
                    // write update query
                    // in this case, it seemed like we have so many fields to pass and 
                    // it is better to label them and not use question marks
                    $query = "UPDATE laptoprecords 
                    SET LaptopID=:laptopid, BorrowerName=:borrowername, BorrowerType=:borrowertype, StartDate=:startdate, EndDate=:enddate, RecordFee=:recordfee, BorrowingStatus=:borrowingstatus, ReturnStatus=:returnstatus, SubmitDate=:submitdate, BorrowPriority=:borrowpriority, BookingStatus=:bookingstatus, BorrowerMail=:borrowermail
                    WHERE LaptopRecordID = :id";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    <td>Laptop ID</td>
                    <td><input type='text' name='txt-laptopid' value="<?php echo htmlspecialchars($laptopid, ENT_QUOTES);  ?>" readonly class='form-control' /></td>
                </tr>
                <tr>
                    <td>Borrower Name</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href='viewolaptopborrowingrecords.php' class='btn btn-danger'>Back to view laptop borrowing records</a>
                    </td>
                </tr>
            </table>
        </form>
