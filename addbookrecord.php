...
<html>
<head>
    <title>The Book Borrowing Record Adding Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Add Book Borrowing Record</h1>
        </div>
        ...
        if($_POST){
            ...
            try{
                ...
                // insert query
                $query = "INSERT INTO bookrecords SET BookID=:bookid, StaffID=:staffid, BorrowerName=:borrowername, BorrowerType=:borrowertype, StartDate=:startdate, BorrowDay=:borrowday, EndDate=:enddate, RecordFee=:recordfee, BorrowingStatus=:borrowingstatus, ReturnStatus=:returnstatus, SubmitDate=:submitdate, BorrowPriority=:borrowpriority, BookingStatus=:bookingstatus, ExtendTime=:extendtime, BorrowerMail=:borrowermail";
