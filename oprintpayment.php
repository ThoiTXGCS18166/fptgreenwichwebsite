...
<head>
    ...
    <title>The Paypal Book Printing Payment Page For Outsider</title>
...
<body>
            ...
            <div class="grid">
                <div class="col-1">
                    <div class="flex item justify-content-between">
                        ...
                        <div>
                            <a href="printodocument.php"> << Cancel the book printing process</a>
                        </div>
                        <div class="price">
                            <h3 class="text-red">| Book Printing Price For Outsier: $25</h3>
                            <br>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="subtotal text-center">
                        ...
                        <ul>
                            <li class="flex justify-content-between">
                                <label for="price">Printed Book Fee: $25</label>
                            </li>
                            <li class="flex justify-content-between">
                            ...
                            <li class="flex justify-content-between">
                                ...
                                <span class="text-red font-title">$25</span>
                            </li>
                        </ul>
    ...
    <script type="text/javascript" src="js/outsiderpayment.js"></script>
