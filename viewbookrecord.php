...
<html>
<head>
    <title>The Specific Book Borrowing Record Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT BookRecordID, BookID, StaffID, BorrowerName, BorrowerType, StartDate, BorrowDay, EndDate, RecordFee, BorrowingStatus, ReturnStatus, SubmitDate, BorrowPriority, BookingStatus, ExtendTime, BorrowerMail FROM bookrecords WHERE BookRecordID = ? LIMIT 0,1";
