...
<html>
<head>
    <title>The Students Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <form action="viewstudents.php" method="POST" autocomplete="off">
        ...
        // select all data
        $query = "SELECT StudentID, StaffID, StudentName, StudentUsername, StudentPhone, StudentMail, StudentStatus FROM students ORDER BY StudentID ASC";
