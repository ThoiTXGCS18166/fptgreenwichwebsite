<?php
  ...
  if(isset($_POST['btn-borrow'])){   
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($paymentstatus == 0) {
        echo '<script>alert("Request for borrowing book submitted unsuccessfully. The current outsider has yet made payment for the yearly membership fee at the library")</script>';
      } else {
...
<head>
    ...
    <title>The Book Borrowing Page For Outsider</title>
    <style>
    * {
...
<div class="sidebar">
  ...
  <a class="active" href="borrowobook.php">Borrow Books</a>
...
<div class="content">
  ...
  <h2>The book borrowing page for outsider</h2>
  <h3>The book borrowing form for outsider</h3>

  <div class="container">
    <form action="borrowobook.php" method="POST">
    <div class="row">
        <div class="col-25">
