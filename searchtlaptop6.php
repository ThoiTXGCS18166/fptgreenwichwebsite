...
<head>
    ...
    <title>The Laptop Searching Page For Teachers</title>
    <style>
    * {
...
<div class="content">
  ...
  <form action="searchtlaptop6.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <form action="searchtlaptop6.php" method="POST">
