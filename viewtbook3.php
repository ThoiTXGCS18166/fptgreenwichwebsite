...
<div class="content">
  ...
  <form action="viewtbook3.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewtbook17detail.php">View Book Details</a></p>
    <form action="viewtbook3.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewtbook18detail.php">View Book Details</a></p>
    <form action="viewtbook3.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook19detail.php">View Book Details</a></p>
    <form action="viewtbook3.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewtbook1.php">1</a>
    <a href="viewtbook2.php">2</a>
    <a href="viewtbook3.php" class="active">3</a>
    </div>
  </div>
