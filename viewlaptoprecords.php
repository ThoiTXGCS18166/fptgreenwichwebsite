...
<html>
<head>
    <title>The Laptop Borrowing Records Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Current Laptop Borrowing Records</h1>
        </div>

        <form action="viewlaptoprecords.php" method="POST" autocomplete="off">
