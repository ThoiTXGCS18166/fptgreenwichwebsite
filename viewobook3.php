<?php
  ...
  if(mysqli_num_rows($result) > 0){
    ...
    if($status17 == 0) {
      $book17status = 'Unavailable';
    } else {
      $book17status = 'Available';
    }
  }
  ...
  if(mysqli_num_rows($result) > 0){
    ...
    if($status18 == 0) {
      $book18status = 'Unavailable';
    } else {
      $book18status = 'Available';
    }
  }
  ...
  if(mysqli_num_rows($result) > 0){
    ...
    if($status19 == 0) {
      $book19status = 'Unavailable';
    } else {
      $book19status = 'Available';
    }
  }
...
<div class="content">
  ...
  <form action="viewobook3.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <?php echo $book17image ? "<img src='img/{$book17image}' style='display: block; margin-left: auto; margin-right: auto; width:100%; height:400px;' />" : "No image found.";  ?>
    <p>Book Author: <?php echo $book17author;?></p>
    <p>Book Pages: <?php echo $book17length;?> pages</p>
    <p>Book Status: <?php echo $book17status;?></p>
    <p style="text-align: center;"><a href="viewobook17detail.php">View Book Details</a></p>
    <form action="viewobook3.php" method="POST">
    <div class="buttonHolder">
    <input type="submit" style="background-color: #4CAF50;" value="Borrow Book" name="btn-borrow17">
    <input type="submit" style="background-color: #555555;" value="Print Book" name="btn-print17">
    </div>
    </form>
    </div>
    <div class="column" style="background-color:#bbb;">
    <?php echo $book18image ? "<img src='img/{$book18image}' style='display: block; margin-left: auto; margin-right: auto; width:100%; height:400px;' />" : "No image found.";  ?>
    <p>Book Author: <?php echo $book18author;?></p>
    <p>Book Pages: <?php echo $book18length;?> pages</p>
    <p>Book Status: <?php echo $book18status;?></p>
    <p style="text-align: center;"><a href="viewobook18detail.php">View Book Details</a></p>
    <form action="viewobook3.php" method="POST">
    <div class="buttonHolder">
    <input type="submit" style="background-color: #4CAF50;" value="Borrow Book" name="btn-borrow18">
    <input type="submit" style="background-color: #555555;" value="Print Book" name="btn-print18">
    </div>
    </form>
    </div>
    <div class="column" style="background-color:#ccc;">
    <?php echo $book19image ? "<img src='img/{$book19image}' style='display: block; margin-left: auto; margin-right: auto; width:100%; height:400px;' />" : "No image found.";  ?>
    <p>Book Author: <?php echo $book19author;?></p>
    <p>Book Pages: <?php echo $book19length;?> pages</p>
    <p>Book Status: <?php echo $book19status;?></p>
    <p style="text-align: center;"><a href="viewobook19detail.php">View Book Details</a></p>
    <form action="viewobook3.php" method="POST">
    <div class="buttonHolder">
    <input type="submit" style="background-color: #4CAF50;" value="Borrow Book" name="btn-borrow19">
    <input type="submit" style="background-color: #555555;" value="Print Book" name="btn-print19">
    </div>
    </form>
    </div>
    ...
    <form action="viewobook3.php" method="POST">
    <div class="buttonHolder">
    <input type="submit" style="background-color: #4CAF50;" value="Borrow Book" name="btn-borrow20">
    <input type="submit" style="background-color: #555555;" value="Print Book" name="btn-print20">
    </div>
    </form>
    </div>
  </div>
  ...
  <div class="center">
    ...
    <a href="viewobook1.php">1</a>
    <a href="viewobook2.php">2</a>
    <a href="viewobook3.php" class="active">3</a>
    </div>
  </div>
