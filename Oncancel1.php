...
<head>
    ...
    <title>The Failed Payment Page For Printing Book Of Student</title>
    <!-- FONT AWESOME ICONS -->
...
<main id="cart-main">
    <div class="site-title text-center">
        ...
        <h1 class="font-title">The Payment For Printing Book Of Student Was Cancelled For Some Reasons</h1>
        <div class="buttonHolder">
          <a href="home3.php" class="button">Back To Student Homepage</a>
        </div>
    </div>
</main>
</body>
