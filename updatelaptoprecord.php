...
<html>
<head>
    <title>The Laptop Borrowing Record Updating Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Update Laptop Borrowing Record Information</h1>
        </div>
        ...
        try {
            ...
            $query = "SELECT LaptopRecordID, LaptopID, StaffID, BorrowerName, BorrowerType, StartDate, BorrowDay, EndDate, RecordFee, BorrowingStatus, ReturnStatus, BorrowPriority, BookingStatus, BorrowerMail FROM laptoprecords WHERE LaptopRecordID = ? LIMIT 0,1";
        ...
        if($_POST){
            ...
            try{
                ...
                $query = "UPDATE laptoprecords 
                            SET LaptopID=:laptopid, StaffID=:staffid, BorrowerName=:borrowername, BorrowerType=:borrowertype, StartDate=:startdate, BorrowDay=:borrowday, EndDate=:enddate, RecordFee=:recordfee, BorrowingStatus=:borrowingstatus, ReturnStatus=:returnstatus, BorrowPriority=:borrowpriority, BookingStatus=:bookingstatus, BorrowerMail=:borrowermail
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    <td>Laptop ID</td>
                    <td><input type='number' name='txt-laptopid' min="1" max="10" value="<?php echo htmlspecialchars($laptopid, ENT_QUOTES);  ?>" class='form-control' readonly/></td>
                </tr>
                <tr>
                    <td>Staff ID</td>
                ...
                <tr>
                    <td>Borrow Days</td>
                    <td><input type='text' name='txt-borrowday' value="<?php echo htmlspecialchars($borrowday, ENT_QUOTES);  ?>" class='form-control' readonly/></td>
                </tr>
                <tr>
                    <td>End Date</td>
                ...
                <tr>
                    <td>Laptop Borrowing Priority</td>
