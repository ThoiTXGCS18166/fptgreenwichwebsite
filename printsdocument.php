<?php
  ...
  if(isset($_POST['btn-print'])){   
    $staffid=1;
    $printername=$_POST['txt-studentusername'];
  ...
  if(isset($_POST['btn-pay'])){
    $_SESSION['printer_name'] = $_POST['txt-studentusername'];
    ...
    if(mysqli_num_rows($result) > 0) {
      ...
      if($bookstatus==0) {
        ...
        header("location: sprintpayment.php");
      }
    } else {
...
<head>
    ...
    <title>The Document Printing Page For Student</title>
    <style>
    * {
...
<div class="sidebar">
  ...
  <a class="active" href="printsdocument.php">Print Documents</a>
...
<div class="content">
  ...
  <h2>The document printing page for student</h2>
  <h3>The document printing form for student</h3>

  <div class="container">
    <form action="printsdocument.php" method="POST">
    <div class="row">
        <div class="col-25">
    ...
    <div class="row">
        ...
        <div class="col-75">
        <input type="text" id="txt-recordfee" name="txt-recordfee" value="Print fee is 20 USD (approximately 460000 VND) for student" readonly data-mini="true">
        </div>
    </div>
    <div class="row">
