...
<html>
<head>
    <title>The Book Borrowing Record Extending Page For Student</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Extend Book Borrowing Record</h1>
        </div>
            ...
            try{
                if($borrowingstatus == 1 && $bookingstatus == 0){
                    ...
                    // it is better to label them and not use question marks
                        ...
                        SET BookID=:bookid, BorrowerName=:borrowername, BorrowerType=:borrowertype, StartDate=:startdate, EndDate=:enddate, RecordFee=:recordfee, BorrowingStatus=:borrowingstatus, ReturnStatus=:returnstatus, SubmitDate=:submitdate, BookingStatus=:bookingstatus, ExtendTime=:extendtime, BorrowerMail=:borrowermail
                        ...
                        echo '<script>alert("This book borrowing record can not be extended anymore")</script>';
                    }  
                } else {
                    echo '<script>alert("This book borrowing record can not be extended")</script>';
                }           
            }
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                ...
                <tr>
                    ...
                    <td><input type='text' name='txt-extendtime' value="<?php echo htmlspecialchars($extendtime, ENT_QUOTES);  ?>" readonly class='form-control' /></td>
                </tr>
                <tr>
                    <td>Borrower Mail</td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href='viewsbookborrowingrecords.php' class='btn btn-danger'>Back to view book borrowing records</a>
                    </td>
                </tr>
            </table>
        </form>
