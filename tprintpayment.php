...
<head>
    ...
    <title>The Paypal Book Printing Payment Page For Teacher</title>
...
<body>
            ...
            <div class="grid">
                <div class="col-1">
                    <div class="flex item justify-content-between">
                        ...
                        <div>
                            <a href="printtdocument.php"> << Cancel the book printing process</a>
                        </div>
                        <div class="price">
                            <h3 class="text-red">| Book Printing Price For Teacher: $20</h3>
                            <br>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="js/teacherpayment.js"></script>
