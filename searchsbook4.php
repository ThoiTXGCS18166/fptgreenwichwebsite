...
<head>
    ...
    <title>The Book Searching Page For Students</title>
    <style>
    * {
...
<div class="content">
  ...
  <h2>The book-searching page for students</h2>
  <h3>The information about the searched book on this website</h3>

  <form action="searchsbook4.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <form action="searchsbook4.php" method="POST">
