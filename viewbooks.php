...
<html>
<head>
    <title>The Books Viewing Page For Administrator</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Current Books</h1>
        </div>

        <form action="viewbooks.php" method="POST" autocomplete="off">
        ...
        // select all data
        $query = "SELECT BookID, CategoryID, AdminID, BookName, AuthorName, BookEdition, BookLength, BookStatus FROM books ORDER BY BookID ASC";
