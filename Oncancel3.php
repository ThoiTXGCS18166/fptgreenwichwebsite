...
<head>
    ...
    <title>The Failed Payment Page For Printing Book Of Outsider</title>
    <!-- FONT AWESOME ICONS -->
...
<main id="cart-main">
    <div class="site-title text-center">
        <div><img src="img/cancel.png" alt=""></div>
        <h1 class="font-title">The Payment For Printing Book Of Outsider Was Cancelled For Some Reasons</h1>
        <div class="buttonHolder">
          <a href="home5.php" class="button">Back To Outsider Homepage</a>
        </div>
    </div>
</main>
</body>
