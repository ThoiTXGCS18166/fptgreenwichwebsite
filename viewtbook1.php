...
<head>
    ...
    <title>The Book Viewing Page For Teachers</title>
    <style>
    * {
...
<div class="content">
  ...
  <h2>The book-viewing page for teachers</h2>
  <h3>The information about the current books on this website</h3>
  
  <form action="viewtbook1.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewtbook1detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewtbook2detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook3detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook4detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewtbook5detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook6detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook7detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook8detail.php">View Book Details</a></p>
    <form action="viewtbook1.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewtbook1.php" class="active">1</a>
    <a href="viewtbook2.php">2</a>
    <a href="viewtbook3.php">3</a>
    </div>
  </div>
