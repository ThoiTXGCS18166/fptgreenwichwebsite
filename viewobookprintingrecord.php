...
<html>
<head>
    <title>The Specific Book Printing Record Viewing Page For Outsider</title>
    ...
    <div class="container">
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                <td></td>
                <td>
                    <a href='viewobookprintingrecords.php' class='btn btn-danger'>Back to view book printing records</a>
                </td>
            </tr>
        </table>
