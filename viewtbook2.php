...
<img src="img/logo.PNG" alt="Library Logo" style="width:45%">
  ...
  <form action="viewtbook2.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewtbook9detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewtbook10detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook11detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook12detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewtbook13detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook14detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook15detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewtbook16detail.php">View Book Details</a></p>
    <form action="viewtbook2.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewtbook2.php" class="active">2</a>
