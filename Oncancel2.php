...
<head>
    ...
    <title>The Failed Payment Page For Printing Book Of Teacher</title>
    <!-- FONT AWESOME ICONS -->
...
<main id="cart-main">
    <div class="site-title text-center">
        ...
        <h1 class="font-title">The Payment For Printing Book Of Teacher Was Cancelled For Some Reasons</h1>
