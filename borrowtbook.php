    ...
    if(mysqli_num_rows($result) > 0){
      ...
      if($bookstatus==0) {
        ...
        if(mysqli_num_rows($result)==2){
          echo '<script>alert("The current book has enough borrowers for reservation. Please choose a different book to borrow.")</script>';
          ...
          if($datetime1 == $datetime2 || $datetime1 == $datetime3) {
            ...
            if ($conn->query($sql) === TRUE) {
              echo '<script>alert("Request for borrowing book submitted successfully. Please often check your book borrowing record or email notification to come to the library on the right day for making payment and receiving the needed book.")</script>';
            } else {
...
<head>
    ...
    <title>The Book Borrowing Page For Teacher</title>
    <style>
    * {
...
<div class="sidebar">
  ...
  <a class="active" href="borrowtbook.php">Borrow Books</a>
...
<div class="content">
  ...
  <h2>The book borrowing page for teacher</h2>
  <h3>The book borrowing form for teacher</h3>

  <div class="container">
    <form action="borrowtbook.php" method="POST">
    <div class="row">
        <div class="col-25">
