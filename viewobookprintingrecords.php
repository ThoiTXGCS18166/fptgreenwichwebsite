...
<html>
<head>
    <title>The Book Printing Records Viewing Page For Outsider</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Outsider Book Printing Records</h1>
        </div>
        ...
        echo "<a href='printodocument.php' class='btn btn-primary m-b-1em'>Print New Book</a>";
        ...
        if($num>0){
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                echo "<tr>";
                    ...
                    echo "<td>";
                        // read one record 
                        echo "<a href='viewobookprintingrecord.php?id={$PrintingID}' class='btn btn-info m-r-1em'>Read</a>";
                                    
                        // we will use this links on next part of this post
                        echo "<a href='cancelobookprintingrecord.php?id={$PrintingID}'  class='btn btn-danger'>Cancel</a>";
                    echo "</td>";
                echo "</tr>";
            }
