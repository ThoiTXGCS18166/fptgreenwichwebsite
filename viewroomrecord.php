...
<html>
<head>
    <title>The Specific Room Borrowing Record Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Specific Room Borrowing Record Information</h1>
        </div>
        ...
        try {
            ...
            $query = "SELECT RoomRecordID, RoomID, StaffID, BorrowerName, BorrowerType, StartDate, BorrowHour, EndDate, RecordFee, BorrowingStatus, ReturnStatus, SubmitDate, BorrowPriority, BookingStatus, BorrowerMail FROM roomrecords WHERE RoomRecordID = ? LIMIT 0,1";
        ...
        <table class='table table-hover table-responsive table-bordered'>
            <tr>
                <td>Room Borrowing Record ID</td>
                <td><?php echo htmlspecialchars($roomrecordid, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
                <td>Room ID</td>
                <td><?php echo htmlspecialchars($roomid, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
                <td>Staff ID</td>
            ...
            <tr>
                <td>Borrow Hours</td>
                <td><?php echo htmlspecialchars($borrowhour, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
                <td>End Date</td>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($borrowpriority, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
