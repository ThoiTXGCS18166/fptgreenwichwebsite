...
<html>
<head>
    <title>The Teachers Searching Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>View Searched Teachers</h1>
        </div>

        <form action="searchteachers.php" method="POST" autocomplete="off">
        ...
        // select all data
        $query = "SELECT TeacherID, StaffID, TeacherName, TeacherUsername, TeacherPhone, TeacherMail, TeacherStatus FROM teachers WHERE TeacherName LIKE'%".$_SESSION['searched_teachername']."%' ORDER BY TeacherID ASC";
