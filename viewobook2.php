...
<div class="content">
  ...
  <form action="viewobook2.php" method="POST" autocomplete="off">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewobook9detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    ...
    <p style="text-align: center;"><a href="viewobook10detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewobook11detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewobook12detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="row">
    ...
    <p style="text-align: center;"><a href="viewobook13detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewobook14detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewobook15detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
    ...
    <p style="text-align: center;"><a href="viewobook16detail.php">View Book Details</a></p>
    <form action="viewobook2.php" method="POST">
    <div class="buttonHolder">
  ...
  <div class="center">
    ...
    <a href="viewobook2.php" class="active">2</a>
