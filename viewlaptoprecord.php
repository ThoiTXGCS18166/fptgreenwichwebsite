...
<html>
<head>
    <title>The Specific Laptop Borrowing Record Viewing Page For Staff</title>
...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT LaptopRecordID, LaptopID, StaffID, BorrowerName, BorrowerType, StartDate, BorrowDay, EndDate, RecordFee, BorrowingStatus, ReturnStatus, SubmitDate, BorrowPriority, BookingStatus, BorrowerMail FROM laptoprecords WHERE LaptopRecordID = ? LIMIT 0,1";
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                <td>Borrow Days</td>
                <td><?php echo htmlspecialchars($borrowday, ENT_QUOTES);  ?></td>
            </tr>
            <tr>
                <td>End Date</td>
